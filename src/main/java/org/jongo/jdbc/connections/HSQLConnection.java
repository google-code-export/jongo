...
public class HSQLConnection extends AbstractJDBCConnection implements JongoJDBCConnection{
    ...
    public String getCreateJongoTableQuery() {
        return "CREATE TABLE JongoTable  ( id INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 0 INCREMENT BY 1) PRIMARY KEY, name VARCHAR(50) NOT NULL UNIQUE, customId VARCHAR(10) DEFAULT 'id', permits INTEGER)";
    }
}
