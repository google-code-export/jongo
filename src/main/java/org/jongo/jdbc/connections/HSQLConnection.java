...
public class HSQLConnection extends AbstractJDBCConnection implements JongoJDBCConnection{
    ...
    public String getCreateJongoQueryTable() {
        return "CREATE TABLE JongoQuery  ( id INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 0 INCREMENT BY 1) PRIMARY KEY, name VARCHAR(50) NOT NULL UNIQUE, query CLOB NOT NULL, description VARCHAR(50))";
    }
