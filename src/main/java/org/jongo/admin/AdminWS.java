...
public interface AdminWS {
    ...
    public Response updateJongoTable(final HttpServletRequest request, final String format, final String id, final String jsonRequest);
    ...
    public Response updateJongoQuery(final HttpServletRequest request, final String format, final String id, final String jsonRequest);
