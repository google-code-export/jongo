 ...
 * JSON and XML output for all the {@link org.jongo.rest.xstream.JongoResponse} objects and add some
...
public class DefaultFormatFilter implements ContainerResponseFilter, JongoFormatFilter {
    ...
    /**
     * Generates a new {@linkplain javax.ws.rs.core.Response} for a given 
     * {@link org.jongo.rest.xstream.JongoError} generating the appropriate XML or JSON representation 
    ...
    /**
     * Generates a new {@linkplain javax.ws.rs.core.Response} for a given 
     * {@link org.jongo.rest.xstream.JongoHead} generating the appropriate XML or JSON representation 
     * and setting the Content-Location header.
     * @param response a {@link org.jongo.rest.xstream.JongoSuccess} to be converted to JSON or XML.
     * @param mime the {@linkplain javax.ws.rs.core.MediaType} used to determine the transport format.
     * @param status the current HTTP code of the response.
