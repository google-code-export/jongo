...
public class JongoUtils {
    ...
    /**
     * Return a String used to create the JongoTable table to persist JongoTable domain objects.
     * @return 
     */
    ...
    /**
     * Return a String used to create the JongoQuery table to persist JongoQuery domain objects.
     * @return 
     */
    public static String getCreateJongoQueryTableQuery(){
        StringBuilder b = new StringBuilder("CREATE TABLE JongoQuery  ( ");
        b.append("id INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 0 INCREMENT BY 1) PRIMARY KEY, ");
        b.append("database VARCHAR(50) NOT NULL, name VARCHAR(50) NOT NULL, query CLOB NOT NULL, description VARCHAR(50))");
        return b.toString();
    }
