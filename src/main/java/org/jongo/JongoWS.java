...
public interface JongoWS {
    ...
    public Response get(String database, String resource, String idField, String id, UriInfo ui);
    ...
    public Response insert(String database, String resource, String idField, String jsonRequest);
    public Response insert(String database, String resource, String idField, MultivaluedMap<String, String> formParams);
    public Response update(String database, String resource, String idField, String id, String jsonRequest);
    public Response delete(String database, String resource, String idField, String id);
